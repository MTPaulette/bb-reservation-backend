...
class PaymentController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        if(
            ...
            if(
                ...
                if($authUser->work_at != $payment->reservation->ressource->agency_id) {
                    abort(403);
                }
            }
            $payment = $this->paymentWithCreator()->findOrFail($request->id);
    ...
    public function store(Request $request)
    {
        ...
        // \LogActivity::addToLog("The reservation id: $reservation->id updated");
